...
static int buscarLugarLibre(Cliente* arrayC,int limite);
//__________________
/** \brief busca lugar libre isEmpy=1
 *
 * \param arrayC Cliente* array como parametro
 * \param limite int limite de la array
 * \return int -1 error array o limite, >0 devuelve indice libre
 *
 */
static int buscarLugarLibre(Cliente* arrayC, int limite)
{
...
/** \brief busca por id
 *
 * \param arrayC Cliente* como parametro
 * \param limite int limite de la array
 * \param id int id para la busqueda
 * \return int -1 error de array o limite, -2 no existe id, 0 ok
 *
 */
...
/** \brief inicializa la array poniendo un 1 a isEmpy
 * \param arrayC Publicacion* array como parametro
 * \param limite int limite de la array
...
int cliente_mostrar(Cliente* arrayC,int limite)
{
    ...
    {
        retorno = 0;
        printf("- ID Cliente -   Nro Cuit   -   Nombre   -     Apellido    - isEmpy \n");
        for(i=0;i<limite;i++)
        {
            if(!arrayC[i].isEmpty)
                printf("- %10d - %12s - %10s - %15s - %5d\n",arrayC[i].idCliente, arrayC[i].cuit, arrayC[i].nombre,arrayC[i].apellido, arrayC[i].isEmpty);
        }
    }
    return retorno;
}
        ...
        for(i=0; i<limiteC; i++)
        {
            indexC=i;
                if(!arrayC[i].isEmpty)
                {
                        ...
                        printf("- %10d - %12s - %10s - %15s - %5d ",arrayC[i].idCliente, arrayC[i].cuit, arrayC[i].nombre,arrayC[i].apellido, arrayC[i].isEmpty);
